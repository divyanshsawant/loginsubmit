  ...
  return (
    <div>
      ...
      <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
        <h1 className="text-4xl text-white  text-center mb-6">Student Registration</h1>
        <form>
        ...
        <span className="text-white mt-4 block">
          Already have an account? <Link to="/login" className="text-white-500 underline text-white-800 hover:text-yellow-500 py-2 transition-colors duration-300">Login here.</Link>
        </span>
      </div>
    </div>
  );
